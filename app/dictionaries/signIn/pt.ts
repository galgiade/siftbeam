...
const pt: SignInLocale = {
  label: {
    ...
    twoFactorAuthDescription: "Digite o código de verificação enviado para {email}",
  ...
  alert: {
    ...
    passwordFormatInvalid: "A senha deve ter pelo menos 8 caracteres com maiúsculas, minúsculas e números",
