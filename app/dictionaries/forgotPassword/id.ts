...
const id: ForgotPasswordLocale = {
  label: {
    ...
    passwordDescription: "Minimal 8 karakter dengan huruf besar, kecil, dan angka",
    sendCode: "Kirim Kode",
  ...
  alert: {
    ...
    invalidPasswordFormat: "Kata sandi harus minimal 8 karakter dengan huruf besar, kecil, dan angka",
