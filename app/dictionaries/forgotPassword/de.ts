...
const de: ForgotPasswordLocale = {
  label: {
    ...
    passwordDescription: "Mindestens 8 Zeichen, mit Groß- und Kleinbuchstaben sowie Zahlen",
  ...
  alert: {
    ...
    invalidEmailFormat: "Bitte gültige E-Mail-Adresse eingeben",
    codeRequired: "Bitte Bestätigungscode eingeben",
    newPasswordRequired: "Bitte neues Passwort eingeben",
    confirmPasswordRequired: "Bitte Passwortbestätigung eingeben",
    passwordMismatch: "Passwörter stimmen nicht überein",
    invalidPasswordFormat: "Passwort muss mindestens 8 Zeichen lang sein und Groß- und Kleinbuchstaben sowie Zahlen enthalten",
