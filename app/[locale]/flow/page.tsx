...
const getFlowKeywordsByLocale = (locale: string): string[] => {
  const keywordMap = {
    ...
    en: ['how to', 'setup', 'getting started', 'tutorial', 'guide', 'onboarding', 'data processing tutorial', 'instructions', 'manual', 'initial setup'],
    zh: ['如何使用', '设置', '入门', '教程', '指南', '入门步骤', '数据处理教程', '操作说明', '手册', '初始设置'],
...
export async function generateMetadata(
  ...
  const dict = pickDictionary(flowDictionaries, resolvedParams.locale, 'en')
...
export default async function FlowPage(
  ...
  const breadcrumbTranslations = {
    ...
    en: { home: 'Home', flow: 'How to Use' },
    zh: { home: '主页', flow: '使用方法' },
    ko: { home: '홈', flow: '사용 방法' },
