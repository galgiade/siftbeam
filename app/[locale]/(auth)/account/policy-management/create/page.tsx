...
import CreatePolicyManagementContainer from '@/app/_containers/PolicyManagement/create/CreatePolicyManagementContainer'
...
export default async function PolicyManagementPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <CreatePolicyManagementContainer locale={locale} />
}
